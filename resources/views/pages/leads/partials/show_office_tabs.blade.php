...
<div class="col-xs-9">
    <div class="tab-content ">
        <div class="tab-pane fade in active" id="informations-{{$office->id}}">
            @include('pages.leads.partials.show_office_information')
        </div>
        <div class="tab-pane fade in" id="contacts-{{$office->id}}">
            @include('pages.leads.partials.show_office_contacts')
        </div>
        <div class="tab-pane fade in" id="notes-{{$office->id}}">
            @include('pages.leads.partials.show_office_notes')
        </div>
        <div class="tab-pane fade in" id="quotes-{{$office->id}}">
            @include('pages.leads.partials.show_office_quotes')
        </div>
    </div>
</div>
