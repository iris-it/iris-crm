<div class="box box-primary">
    <div class="box-body">
        ...
        <div class="form-group col-sm-6">
            ...
            @if($invoice->account)
                <span class="h4 text-bold">{!! $invoice->account->name !!}</span>
            @else
...
<div class="box box-primary">
    <div class="box-body">
        ...
        <div class="form-group col-sm-12">
            {!! Form::label('quote_name', trans('app.general:quote') . " :", ['class' => 'h4 text-purple']) !!}
            @if($invoice->quote)
                <span class="h4 text-bold">{!! $invoice->quote->topic !!}</span>
            @else
                <span class="h4 text-bold">{{trans('app.general:undefined')}}</span>
            @endif
        </div>
        ...
        <div class="form-group col-sm-6">
            {!! Form::label('products_list', trans('app.invoice:products-list') . " :", ['class' => 'h4 text-purple']) !!}
        ...
        <div class="form-group col-sm-6">
            {!! Form::label('services_list', trans('app.invoice:services-list') . " :", ['class' => 'h4 text-purple']) !!}
...
<div class="box box-primary">
    <div class="box-body">
        ...
        <div class="form-group col-sm-6">
            ...
            @if($invoice->contact)
                <span class="h4 text-bold">{!! $invoice->contact->firstname . " " . $invoice->contact->lastname !!}</p>
            @else
                <span class="h4 text-bold">{{trans('app.general:undefined')}}</span>
            @endif
        </div>
