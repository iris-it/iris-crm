<aside class="main-sidebar">
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li><a href="{{ action('HomeController@index') }}"><i class="fa fa-dashboard"></i>
                    <span>{{trans('app.general:dashboard')}}</span></a></li>
            <li><a href="{{ action('AccountController@index') }}"><i class="fa fa-briefcase"></i>
                    <span>{{trans('app.general:accounts')}}</span></a></li>
            <li><a href="{{ action('LeadController@index') }}"><i class="fa fa-fire"></i>
                    <span>{{trans('app.general:leads')}}</span></a></li>
            <li><a href="{{ action('ContactController@index') }}"><i class="fa fa-user"></i>
            ...
            <li><a href="{{ action('OrderController@index') }}"><i class="fa fa-line-chart"></i>
                    <span>{{trans('app.general:orders')}}</span></a></li>
            ...
            <li><a href="{{ action('ServiceController@index') }}"><i class="fa fa-truck"></i>
                    <span>{{trans('app.general:services')}}</span></a></li>
            <li><a href="{{ action('TaxController@index') }}"><i class="fa fa-percent"></i>
